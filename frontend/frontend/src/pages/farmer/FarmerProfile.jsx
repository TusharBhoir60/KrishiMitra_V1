...
export const FarmerProfile = () => {
  ...
  const handleSave = () => {
    // In production: dispatch an updateProfile thunk here
    ...
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-8">
      ...
      <div className="bg-gradient-to-r from-farm-green to-farm-mid px-6 py-10 md:px-10 relative overflow-hidden">
        ...
        <div className="relative flex items-center gap-5">
          ...
          <div>
            <p className="text-farm-pale/70 text-xs font-semibold uppercase tracking-widest mb-0.5">Farmer Profile</p>
        ...
        {user?.isVerified && (
          <div className="relative mt-4 inline-flex items-center gap-1.5 bg-white/20 px-3 py-1 rounded-full text-white text-xs font-semibold">
            <ShieldCheck size={13} /> KrishiMitra Verified
          </div>
        )}
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-gray-50">
            {[
              ...
              { label: 'Farm Type',    icon: Tractor, field: 'farmType', type: 'text', placeholder: 'e.g. Mixed, Organic, Cash Crops' },
              { label: 'Farm Size',    icon: Tractor, field: 'farmSize', type: 'text', placeholder: 'e.g. 5 acres' },
            ...
            <div className="flex items-start px-6 py-4 gap-4">
              ...
              <div className="flex-1">
                <p className="text-xs text-gray-400 mb-0.5">Bio / About Farm</p>
                {editing ? (
                  <textarea
                    rows={3}
                    value={form.bio}
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          {[
            ...
            { label: 'Payment & Bank Details', icon: FileText, to: null },
