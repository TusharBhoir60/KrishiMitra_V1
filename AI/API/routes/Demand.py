...
class DemandForecastRequest(BaseModel):
    cropName:               str                   = Field(..., description="Crop name e.g. Tomato")
    ...
    historicalDemandScores: Optional[List[float]] = Field(None, description="Last N weeks of demand scores 0-1")
    historicalPrices:       Optional[List[float]] = Field(None, description="Last N weeks of avg prices")
    forecastWeeks:          int                   = Field(1, ge=1, le=8, description="Weeks ahead to forecast")
