...
from API.routes.Recommendation import router as recommendation_router  # noqa: E402
from API.routes.PriceRange import router as price_range_router  # noqa: E402
...
app.include_router(recommendation_router, prefix="/api/recommendation", tags=["Phase 4 — Crop Recommendation"])
app.include_router(price_range_router, prefix="/api/price-range", tags=["Phase 5 — Price Range"])
